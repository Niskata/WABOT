            ...
            client.simulateTyping(chat.id, true).then(async () => {
                switch (command) {
                    ...
                    case 'owner':
                        ...
                        break
                    case 'join':
                        if (!isOwnerBot) return client.reply(from, 'Maaf Fitur ini Hanya bisa digunakan oleh Owner Bot !', id)
                    ...
                    case 'nulis': {
                        ...
                        await client.sendFileFromUrl(from, urlnulis, 'Nulis.jpeg', 'Nih anjim')
                     break
                    }
                    ...
                    case 'buildgi': {
                        ...
                        if (args[0] === 'ningguang') {
                           await client.sendFileFromUrl(from, `https://pbs.twimg.com/media/Em-fPLbXIAMeGHs.jpg`, 'ningguang.jpg', 'NINGGUANG')
                            ...
                            await client.reply(from, 'BUILD EULA \n', id)
                        }
                        else if (args[0] === 'qiqi') {
                    ...
                    case 'anime':
                        ...
                        if (args[0] === 'loli' || args[0] === 'milf' || args[0] === 'takagi' || args[0] === 'kanna') {
                            client.sendFileFromUrl(from, `https://zenzapi.xyz/api/random/${args[0]}?apikey=zenz`, `Anime.jpg`, '', id)
                        }
                    break
                    case 'memes':
