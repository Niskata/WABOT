 			...
 			if (!isGroupMsg) return client.reply(from, 'Perintah ini hanya bisa digunakan dalam grup', id)
                    ...
                    case 'tiktok': case 'tt':
                        ...
                        case 'ttmp3': {
                            ...
                            else client.reply('Maaf, link yang kamu kirim tidak valid.')
                            break
                        }
