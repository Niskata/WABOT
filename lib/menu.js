...
exports.textMenu = (pushname, t) => {
    ...
    return `
Hi, ${pushname}!
${(3 < n && n <= 9) ? `*Ohayo 🌤️*\nSelamat Beraktifitas 😊😊` : (9 < n && n <= 14) ? `*Konichiwa ☀️*` : (14 < n && n <= 18) ? `*Konbanwa 🌻*` : `*Oyasuminasai 💤*`} 👋️
┏━┳━┳━┳┳━━┳━┓
┃╋┃┳┫┃┃┃┏━┫┳┛
┃┓┫┻┫┃┃┃┗┓┃┻┓
┗┻┻━┻┻━┻━━┻━┛
Berikut adalah beberapa fitur yang ada pada bot ini!✨
${readMore}Note: Selain \`\`\`(${prefix})\`\`\` bot juga akan merespon simbol berikut:
\`\`\`! $ % & + . , < > -\`\`\`
...
Ovo: 082327759039
Dana: 085156863516
saweria: https://saweria.co/RengeBot
